...
<template>
  ...
  >
    ...
    >
      <h3 class="Title text-base md:text-xl lg:text-3xl self-stretch font-display font-bold leading-5 line-clamp-1">
        {{ title }}
      </h3>
    ...
    <div
      class="AuthorInfosWrapper w-full text-xs md:text-lg lg:text-xl leading-4 h-min font-medium flex flex-row justify-between gap-2 flex-wrap-reverse gap-y-0"
    >
